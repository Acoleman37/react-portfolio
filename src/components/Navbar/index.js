        ...
        <header className="bg-black md:sticky top-0 z-10">
            ...
            <a href="#about" className="ml-3 text-xl title-font font-medium text-white mb-4 md:mb-0">Alec Coleman</a>
                <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-white flex flex-wrap items-center text-base text-white">
                    ...
                    <a href="#projects" className="mr-5 hover:text-green-500">Previous Work</a>
                    <a href="https://github.com/Acoleman37" target="_blank" rel="noreferrer noopener" className="mr-5 hover:text-green-500">GitHub</a>
                    ...
                    <a href = {Pdf} className="mr-5 hover:text-green-500">Resume</a>
                </nav>
                <a href="#contact" className="inline-flex items-center bg-black border-0 py-1 px-3 focus:outline-none hover:bg-green-600 text-white rounded text-base mt-4 md:mt-0">Contact<ArrowRightIcon className="w-4 h-4 ml-1" />
                </a>
            </div>
        </header>
    );
